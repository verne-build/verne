...
const grammarLoaders = new Map<string, GrammarLoader>([
  ...
  ["source.mdx", loadRawGrammar("../grammars/mdx.tmLanguage.json", "mdx.tmLanguage.json")],
  ["text.markdown.mdc", loadRawGrammar("../grammars/mdc.tmLanguage.json", "mdc.tmLanguage.json")],
